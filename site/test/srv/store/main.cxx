...
int main (int argc, char * argv [], char * envp [])
{
	...
	{
		std::string option;
		noware::vos::srv::store </*val_t */char unsigned, /*key_t */uint64_t, /*grp_t *//*cln::nr*/int unsigned> dam;
		...
		do
		{
			...
			for (std::pair </*cln::nr*/int unsigned, std::map <uint64_t, char unsigned>> const & group : dam.data)
			{
				for (std::pair <uint64_t, char unsigned> const & key : group.second)
				{
