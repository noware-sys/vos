...
UNICORN_EXPORT
uc_err const uc_store_usr_get (uc_engine * const uc, uint64_t const addr, void * const bytes, size_t const size)
{
}

UNICORN_EXPORT
uc_err const uc_store_usr_set (uc_engine * const uc, uint64_t const addr, void * const bytes, size_t const size)
{
}
