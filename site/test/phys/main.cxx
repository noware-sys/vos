...
int main (int argc, char * argv [])
{
	...
	noware::pause ("Press [Enter] to initialize the machine . . . ");
	
	if (!m/*.cpu*/.init ())
	{
		std::cout << "'" << argv [0] << "': error: could not initialize the machine" << std::endl;
		
		return EXIT_FAILURE;
	}
	
	
	noware::pause ("Press [Enter] to load the instructions file . . . ");
	...
	*/
	noware::pause ("Press [Enter] to start the machine . . . ");
	
	if (!m/*.cpu*/.start ())
	{
		std::cout << "'" << argv [0] << "': error: could not start the machine" << std::endl;
	...
	std::cout << "'" << argv [0] << "': machine: running" << std::endl;
