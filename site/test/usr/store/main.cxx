...
int main (int argc, char * argv [], char * envp [])
{
	...
	/*cln::nr*/int unsigned group;
	uint64_t name;
	char unsigned value;
	//noware::cmach::store dam;	// Direct Access Memory.
	noware::vos::usr::store </*val_t */char unsigned, /*key_t */uint64_t, /*grp_t *//*cln::nr*/int unsigned> dam;
	...
	do
	{
		...
		else if (selection == "4")
		{
			...
			std::cout << "  " << "Removing : [" << group << "][" << name << "] ... " << (dam.del (group, name) ? "Success" : "Failure") << std::endl;
