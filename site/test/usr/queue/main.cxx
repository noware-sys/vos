...
int main (int argc, char * argv [], char * envp [])
{
	...
	std::string element;
	noware::vos::usr::queue <std::string> q;
	...
	do
	{
		...
		{
			std::cout << "  " << "Next+Dequeue [" << (succ = q.next_dequeue (element)) << ']' << std::endl;
			if (succ)
				std::cout << "  " << "  element [" << element << ']' << std::endl;
		}
		else if (selection == "5")
		{
			std::cout << "  " << "Next [" << (succ = q.next (element)) << ']' << std::endl;
			if (succ)
				std::cout << "  " << "  element [" << element << ']' << std::endl;
		}
		else if (selection == "6")
		...
		{
			std::cout << "  " << "Clearing ... " << q.clear () << std::endl;
		}
		else //if (selection != 0)
		{
