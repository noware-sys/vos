...
{
	LIB::deserialize <LIB::cluster::processor::instruction> (serial, *this);
...
{
	LIB::deserialize <LIB::cluster::processor::instructions> (serial, *this);
...
//{
//	LIB::deserialize <LIB::cluster::processor::queue> (serial, *this);
//
//	return *this;
//}
...
//void LIB::cluster::processor::operator () (void)
{
	...
	*/
	...
	while (running_main)
	{
		...
		//LIB::deserialize <LIB::cluster::processor::instructions> (memory.get ("queue"), instructions_temp);
