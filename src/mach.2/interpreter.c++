	...
	do
	{
		...
		switch (token_p -> type_id ())
		{
			...
			case QUEX_TKN_OUTPUT:
				instruction_internal.action = LIB::cluster::processor::operation::output;
				...
				do
				{
					...
					switch (token_p -> type_id ())
					{
						...
						case QUEX_TKN_ASSIGNMENT:
							//instruction_internal.output = token_p -> pretty_char_text ();
							instruction_internal.action = LIB::cluster::processor::operation::assignment;

							break;

						case QUEX_TKN_ADDITION:
							instruction_internal.action = LIB::cluster::processor::operation::addition;

							break;

						case QUEX_TKN_SUBSTRACTION:
							instruction_internal.action = LIB::cluster::processor::operation::substraction;

							break;

						case QUEX_TKN_MULTIPLICATION:
							instruction_internal.action = LIB::cluster::processor::operation::multiplication;

							break;

						case QUEX_TKN_DIVISION:
							instruction_internal.action = LIB::cluster::processor::operation::division;

							break;

						case QUEX_TKN_MODULO:
							instruction_internal.action = LIB::cluster::processor::operation::modulo;
