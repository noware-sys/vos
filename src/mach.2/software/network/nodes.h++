...
#include "../../../default.h++"
#include "../storage/containers/variable.h++"
#include "../storage/containers/array.h++"
#include "../../../mathematics.h++"
#include "../../devices/network/ips/mpi.h++"
#include "../../devices/network/ips/ip.h++"
	...
	//	public:
			...
			class nodes
			{
				...
				protected:
					...
					LIB::NAME_A <node /*Value ("member" entity)*//*, std::string *//*Key (Name (Unique))*/, LIB::mathematics::numbers::natural> _nodes;
