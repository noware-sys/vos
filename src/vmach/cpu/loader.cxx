...
const bool noware::vmach::cpu::loader::load_file (const std::string & file_name, std::string thread_id)
{
	std::ifstream file;
...
const std::string/* value*/ noware::vmach::cpu::loader::get (const std::string & key) const
{
	return get (std::string (""), key);
}

const bool/* success*/ noware::vmach::cpu::loader::set (const std::string & group, const std::string & key, const std::string & value)
{
...
const bool/* success*/ noware::vmach::cpu::loader::set (const std::string & key, const std::string & value)
{
	return set (std::string (""), key);
}

bool const noware::vmach::cpu::loader::enqueue (std::string const & element)
{
	//return false;
	...
	//if (std::string (multival (zmq::msg (expression_serial), "noware::mach::queue::nonfull")) == "1")
	{
		...
		node.anycast (notice, peer_id, mach::cpu::grp_dft);
...
const bool/* success*/ noware::vmach::cpu::loader::search (zmq::msg & msg_result, const zmq::msg & msg_resp, const noware::nr &/* total, expected resonses count*/, const noware::nr &/* current count of peers who responded (so far)*/, const std::string &/* src*/, const net::cast &/* src_cast*/)
{
