...
bool const/* success*/ noware::vmach::cpu::extractor::load_file (std::string const & file_name)
{
	//noware::elf elf;
...
bool const/* success*/ noware::vmach::cpu::extractor::extract (std::string const & input_file_name, std::string const & output_file_name)
{
	/*
	std::ofstream file;
...
bool const/* success*/ noware::vmach::cpu::extractor::clear (void)
{
	content.clear ();
	//_loaded = false;
	elf.clear ();
...
bool const & noware::vmach::cpu::extractor::loaded (void) const
{
	return elf.loaded ();
}
