...
bool const/* success*/ noware::mach::tool::store::extractor::load_file (std::string const & file_name)
{
	//noware::elf elf;
...
bool const/* success*/ noware::mach::tool::store::extractor::clear (void)
{
	content.clear ();
	//_loaded = false;
	elf.clear ();
...
bool const & noware::mach::tool::store::extractor::loaded (void) const
{
	return elf.loaded ();
}
