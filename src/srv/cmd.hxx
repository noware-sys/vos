		...
		namespace srv
		{
				...
				//: virtual public cluster::node
			{
				public:
					...
					virtual bool const set (std::string const &/* value*/);
					virtual std::string const get (char const &/* delimiter*/ = '\n');
				...
				//protected:
					...
					virtual const bool/* success*/ search_local (zmq::msg const &/* result*/, const zmq::msg &/* message/expression*/, const std::string &/* src*/, const net::cast &/* src_cast*/);// const
