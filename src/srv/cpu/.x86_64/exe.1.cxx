...
bool const noware::smach::cpu::x86_64::exe (_DInst const & _insn, std::string & insn_ptr, std::string const & thread_id)
{
	...
	{
		case /*vmach::cpu::*/x86_64::opn::_int:
			// an interrupt system call
			...
			return true;
		case /*vmach::cpu::*/x86_64::opn::_nop:
			// a null operation
			// there is no need to effectively do anything
			return true;
		case /*vmach::cpu::*/x86_64::opn::_mov:
		...
		default:
			// undefined operation
			std::cerr << "noware::smach::cpu::exe()::operation::undefined" << std::endl;
			return false;
	}
}
