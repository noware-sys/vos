const bool noware::mach::cpu::loader::load_file (const std::string & file_name, std::string thread_id)
{
	std::ifstream file;
...
bool const noware::mach::cpu::loader::enqueue (std::string const & element)
{
	//return false;
