...
LIB::cluster::machine::machine (const machine & other)
{
	operator= (other);
}
...
void LIB::cluster::machine::serialize (archive & arch, const unsigned int & version)
{
	//arch & t;
	//arch & l;
	//arch & _active;
...
*/
const LIB::cluster::machine & operator = (const std::string & serial)
{
	deserialize (serial);
...
{
	return LIB::serialize <LIB::cluster::machine> (* this);
}

const bool deserialize (const std::string & serial)
{
	return LIB::deserialize <LIB::cluster::machine> (serial, * this);
}

const LIB::cluster::machine & LIB::cluster::machine::operator = (const machine & other)
{
	if (t == type::literal)
	{
...
const bool LIB::cluster::machine::run (const bool & state)
{
...
const bool & LIB::cluster::machine::active (void) const
{
	return _active;
}
...
const LIB::NAME_A <LIB::cluster::machine, LIB::mathematics::numbers::natural> LIB::cluster::machine::peers (const bool & recursive)
{
	switch (recursive)
	{
		case false:
			...
			LIB::NAME_A <LIB::cluster::machine, LIB::mathematics::numbers::natural> nodes;
...
const LIB::NAME_A <LIB::machine::resource *, std::string> LIB::cluster::machine::resources (void) const
{
	/*
	switch (recursive)
	{
...
/*
const LIB::NAME_A <LIB::network::ip::address, LIB::mathematics::numbers::natural> & LIB::cluster::machine::addresses (void)
{
