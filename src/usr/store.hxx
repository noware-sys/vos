	...
	namespace vos
	{
		namespace usr
		{
				...
				//, virtual public misc::iterator <std::tuple <std::string, std::string, std::string>>
			{
				...
				//	virtual bool const exist (grp_t const &/* key*/) const;
				...
				private:
					...
					virtual bool const/* success*/ search_remote (zmq::msg const &/* overall/final result*/, zmq::msg const &/* current response message/expression*/, cln::nr const &/* total, expected resonses count*/, cln::nr const &/* current count of peers who responded (so far)*/, std::string const &/* src*/, net::cast const &/* src_cast*/);// const
			};
		}
	}
}
