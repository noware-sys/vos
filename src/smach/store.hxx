	...
	namespace smach
	{
			...
			//, virtual public misc::iterator <std::tuple <std::string, std::string, std::string>>
		{
			public:
				...
				// obtain attain get
				virtual bool const/* success*/ get (std::string const &/* key*/, std::string const * &/* value*/) const;
				virtual bool const/* success*/ get (std::string const &/* group*/, std::string const &/* key*/, std::string const * &/* value*/) const;
