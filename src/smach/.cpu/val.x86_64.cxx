...
bool const noware::smach::cpu::val (/*vmach::cpu::*/x86_64::instr const & instr)
{
	...
	switch (instr.operation)
	{
		...
		case /*vmach::cpu::*/x86_64::opr::_mov:
			std::cerr << "noware::smach::cpu::val()::mov(thread_id=\"" << thread_id << "\", dest=\"" << instr.arg1.term1.val << "\", src=\"" << instr.arg2.term1.val << "\")" << std::endl;
			return set (thread_id, instr.arg1.term1.val, instr.arg2.term1.val);
		default:
			std::cerr << "noware::smach::cpu::val()::operation::other" << std::endl;
			return false;
	}
}
